...
*TODO: Add CLA details here.*

### Review our Community Guidelines

This project follows standard open source community guidelines. Please be respectful and constructive.
...
If you're looking for an issue to work on, check out our list of issues that are labeled ["help wanted"](https://github.com/dloring1988/agent-cli/issues?q=is%3Aissue+state%3Aopen+label%3A%22help+wanted%22).
...
```bash
git clone https://github.com/dloring1988/agent-cli.git # Or your fork's URL
cd agent-cli
```
...
To start the CLI from the source code (after building), run the following command from the root directory:
...
The integration tests are designed to validate the end-to-end functionality of the CLI. They are not run as part of the default `npm run test` command.
...
- Consult [AGENT.md](https://github.com/dloring1988/agent-cli/blob/main/AGENT.md) for specific instructions related to AI-assisted development, including conventions for comments, and Git usage.
...
- `packages/`: Contains the individual sub-packages of the project.
  ...
  - `core/`: The core backend logic for the CLI.
